...
newPara2.innerText = "Append inserts as last child";
box2.append(newPara2);
...
console.log(box2.classList.toggle("awesome-box"));

// Using the remove classList proeprty remove the class `awesome-box` from box 4
console.log(box4.classList.remove("awesome-box"))

// Change the background of the body to bisque
console.log(document.body.style.backgroundColor = "bisque");
...
console.log(btn.style.backgroundColor = "oldlace");

// Change the font size of the btn to 1rem
console.log(btn.style.fontSize = "1rem");

// Change the border of the btn to '1px solid black'
console.log(btn.style.border = "1px solid black");

// Add the padding of '0.5rem 1rem' to btn
console.log(btn.style.padding = " 0.5rem 1rem")
...
imageElement.src = "https://images.unsplash.com/photo-1592500595497-d1f52a40b207?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=80";
...
console.log(box7.innerText = "")

// Append the imgElm to the box no 7
console.log(box7.append(imageElement));

// Change the width and height of the image to `100%`
console.log(imageElement.style.width = "100%");
console.log(imageElement.style.height = "100%");
...
console.log(boxFive.append(input));
...
console.log(boxfive.append(anchor1, anchor2));